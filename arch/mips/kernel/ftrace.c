...
/*
 * Instructions about the calling site of mcount for kernel, modules on MIPS.
 *
 * 1. For kernel:
 *
 * move at, ra
...
#define	OFFSET_INSNS		5
#else
#define	OFFSET_INSNS		4
#endif
#define INSN_B_1F_OFFSET	(0x10000000 | OFFSET_INSNS)
		    ...
		    struct dyn_ftrace *rec, unsigned long addr)
{
	 ...
	 * needed.
	 */
	new = in_kernel_space(ip) ? INSN_NOP : INSN_B_1F_OFFSET;
