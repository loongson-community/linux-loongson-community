...
/* names used in hub_diags.c; carried over from IP27 */
 ...
 * redefined big window 7 as small window 0.
 XXX does this still apply for IP35??
 */
...
/*************************************************************************
 ...
 This is in order to maintain compatibility in IP27 and IP35 code
 ...
 */
typedef ii_icrb0_a_u_t icrba_t;	/* what it was called on IP27/hub */
...
#if _KERNEL
#if _LANGUAGE_C
/* XXX moved over from SN/SN0/hubio.h -- each should be checked for IP35 */
#include <alenlist.h>
#include <dmamap.h>
#include <iobus.h>
