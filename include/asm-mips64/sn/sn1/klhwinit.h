 ...
 *	 	other files.
 */
#ifndef _ASM_SN_SN1_KLHWINIT_H
#define _ASM_SN_SN1_KLHWINIT_H

#include <asm/sn/sn1/klhwinit_gfx.h>  /* gfx hw - part & widget numbers */
...
/* IP35 I/O Brick part numbers */
#define PBRICK_PART_NUM			"030-9990-"	/* BRINGUP: dummy # */
#define IBRICK_PART_NUM			"030-9991-"	/* BRINGUP: dummy # */
#define XBRICK_PART_NUM			"030-9992-"	/* BRINGUP: dummy # */
...
#define	HUBUART_P		0x0300fafa /* L1 console protocol mode */
#define HUBUART_D		0x0300fafb /* L1 console direct mode   */
#define SABLE_DISK		0x0300fafe
#define UNIVERSE_VME		0x10e3 
#define FIBERCHANNEL		0x11609004
#define PSITECH_RAD1            0x00093d3d
#define QLOGIC_FIBER1		0x21001077
#define QLOGIC_FIBER2		0x22001077
#define OHCI_1394		0x8009104c
